...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'fadilah.habibi09@gmail.com'; // Ganti dengan email Anda
        $mail->Password = 'plrg tesz dqxy nunz';    // Ganti dengan password aplikasi
        ...
        // Penerima (Email Anda)
        $mail->addAddress('fadilah.habibi09@gmail.com', 'SD-Pelita Bangsa');
        ...
        window.location.href = '../main-page/index.php'; // Redirect kembali ke form
      </script>";
} catch (Exception $e) {
// Pop-up pesan gagal
echo "<script>
